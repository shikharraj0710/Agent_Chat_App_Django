# Generated by Django 4.2.1 on 2025-01-18 15:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('waiting', 'Aaiting'), ('active', 'Active'), ('closed', 'Closed')], default='waiting', max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
